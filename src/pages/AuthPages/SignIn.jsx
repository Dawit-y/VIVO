  ...
  return (
    <main className="w-full flex">
      <div className="relative flex-1 hidden items-center justify-center h-screen lg:flex bg-transparent">
        <div className="relative z-10 w-full max-w-md h-screen overflow-clip">
          <div className=" mt-6 space-y-3 text-center">
            <h3 className="text-3xl font-bold">
              Start growing your knowledge quickly
            </h3>
            <p className="text-gray-500">
              Login to your account and get access to all features for 30-days,
              No credit card required.
            </p>

            <img
              className="rounded-tl-2xl rounded-tr-2xl"
              src="https://images.unsplash.com/photo-1470434767159-ac7bf1b43351?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDF8fHxlbnwwfHx8fHw%3D"
              alt=""
            />
          </div>
        </div>
