...
const OrganizationVolunteerWorks = () => {
  ...
  if (error)
    return <ErrorMessage message={"Error: fetching volunteer works"} />;
...
export default OrganizationVolunteerWorks;
