    ...
    <>
      <div>
        ...
        <nav
          id="sidebar"
          ref={sidebar}
          className={`flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-80 2xl:!w-80 shrink-0 bg-white dark:bg-slate-800 p-4 transition-all duration-200 ease-in-out ${
          ...
          <div class="flex flex-col h-full px-4">
            <div className="h-20 flex items-center pl-2">
              <div className="w-full flex items-center gap-x-4">
                ...
                />
                <div>
                  <span className="block text-gray-700  dark:text-slate-400 text-sm font-semibold">
                    Alivika tony
                  </span>
                  <span className="block mt-px text-gray-600  dark:text-slate-400 text-xs">
                    Hobby Plan
                  </span>
                </div>
                <div className="relative flex-1 text-right">
                  <button
                    ref={profileRef}
                    className="p-1.5 rounded-md text-gray-500  dark:text-slate-400 hover:bg-gray-50 active:bg-gray-100"
                  ...
                  {isProfileActive ? (
                    <div className="absolute z-10 top-12 right-0 w-64 rounded-lg  dark:text-slate-400 dark:bg-slate-800 bg-white shadow-md border text-sm text-gray-600">
                      <div className="p-2 text-left">
                        <span className="block  dark:text-slate-400 text-gray-500/80 p-2">
                          alivika@gmail.com
                        </span>
                        <a
                          href="javascript:void(0)"
