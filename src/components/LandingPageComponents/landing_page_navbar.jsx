...
export default () => {
  ...
  return (
    <>
      <nav
        className={`sticky top-0 z-20 backdrop-blur bg-white/50 w-full dark:bg-slate-200 md:text-sm font-semibold md:border-none ${
      ...
      >
        <div className="items-center gap-x-14 px-4 max-w-screen-xl mx-auto md:flex md:px-8">
          <div className="flex items-center justify-between py-3 md:py-5 md:block">
            <Link to="/">
              <img src={logo} width={100} height={50} alt="Our Logo" />
            </Link>
      ...
      {state ? (
        <div
          className="z-10 fixed top-0 w-screen bg-black/20 backdrop-blur-sm md:hidden"
