          ...
          <ul class="md:grid md:grid-cols-3 md:col-gap-10 md:row-gap-10">
              ...
              <div class="flex flex-col items-center">
                <div class="flex-shrink-0 top-0 -mt-16">
                  <button
                    ...
                    class="flex items-center justify-center lg:h-18 lg:w-18 h-14 w-14 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold"
                  >
                    <svg
            ...
            <li class=" bg-gray-100 p-5 pb-10 text-center dark:bg-slate-800">
              <div class="flex flex-col items-center">
                <div class="flex-shrink-0 top-0 -mt-16">
                  <button
                    onClick={() => handleStepClick("achievements")}
                    class="flex items-center justify-center lg:h-18 lg:w-18 h-14 w-14 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
